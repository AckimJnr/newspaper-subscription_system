      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="{{route('mysubscription')}}" aria-current="page">
        ...
        <section class="py-5 text-center container">
          <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
              <h1 class="fw-light">Subscriptions</h1>
              <p class="lead text-muted">The List of publications you have subscribed to<br /><strong>You can add friend or family to your current package</strong></p>
              <p>
                <a href="#" class="btn btn-primary my-2">New Subscription</a>
                <a href="#" class="btn btn-secondary my-2">Add someone to my current package</a>
              </p>
            </div>
          </div>
        </section>
